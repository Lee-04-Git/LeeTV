...
const CW_GRAY = "#141414";
const CW_LIGHT_GREEN = "#00D94E";

const TheCWScreen = ({ navigation }) => {
  ...
  const loadContent = async () => {
    setLoading(true);
    try {
      const content = await fetchStructuredFranchiseContent("The CW");
      ...
      console.error("Error loading The CW content:", error);
    } finally {
      setLoading(false);
    }
  };
        ...
        <View style={styles.sectionHeader}>
          ...
          {section.data.length > 5 && (
            <TouchableOpacity onPress={() => handleSeeAll(section)} style={styles.seeAllBtn}>
              ...
              <Ionicons name="chevron-forward" size={14} color={CW_GREEN} />
            </TouchableOpacity>
          )}
        </View>
        <FlatList
        ...
        >
          {featuredItems.map((item) => (
            ...
            >
              ...
              >
                <LinearGradient
                  colors={['transparent', 'rgba(0,0,0,0.6)', CW_DARK]}
                  locations={[0.3, 0.65, 1]}
                  style={styles.heroGradient}
                >
                  <View style={styles.heroContent}>
                    <View style={styles.cwTag}>
                      <Text style={styles.cwTagText}>THE CW</Text>
                    </View>
                    ...
                    <View style={styles.heroButtons}>
                      <TouchableOpacity style={styles.watchBtn} onPress={() => handleContentPress(item)}>
                        ...
                        <Text style={styles.watchBtnText}>Watch Free</Text>
                      </TouchableOpacity>
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Image 
          source={require("../../assets/cw-network-logo.png")} 
          style={styles.loadingLogo}
          resizeMode="contain"
        />
        <ActivityIndicator size="small" color={CW_GREEN} style={{ marginTop: 20 }} />
      </View>
    );
  }
